            ...
            <aside className="min-w-0 lg:sticky lg:top-4">
              <PlannerForm
                ...
                labels={{
                  ...
                  inputSemantics: copy.form.inputSemantics,
        ...
        {page === 'methodology' ? (
          <div className="mx-auto max-w-[82rem] space-y-6 px-4 pb-8 sm:px-6 lg:px-8">
            ...
            <Glossary labels={{
              ...
              usualReviews: copy.glossary.usualReviewsTerm,
              usualReviewsDefinition: copy.glossary.usualReviewsDefinition,
              colorQuestion: copy.glossary.colorQuestion,
              colorAnswer: copy.glossary.colorAnswer,
...
function makeScenarioLabels(copy: Copy) {
  return {
    ...
    card: copy.common.units.card,
    cardPerDay: copy.common.units.cardPerDay,
    reviewPerDay: copy.common.units.reviewPerDay,
    studyDay: copy.common.units.studyDay,
    workingDay: copy.common.units.workingDay,
...
function makeTrendLabels(copy: Copy) {
  return {
    ...
    overdueHelp: copy.trend.overdueBacklogHelp,
...
function makeExportLabels(copy: Copy): ExportLabels {
  return {
    ...
    inputInterpretation: copy.export.inputInterpretationHeading,
    overdueInputRule: copy.export.overdueInputRule,
    usualReviewsInputRule: copy.export.usualReviewsInputRule,
    ...
    withoutHardCardOverhead: copy.breakdown.withoutHardCardOverhead,
    direction: copy.scenarios.current.direction,
    backlogDirection: copy.export.backlogDirection,
    currentOverdueBacklog: copy.export.currentOverdueBacklog,
